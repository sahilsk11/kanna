...
export type ClientCommand =
  ...
  | { type: "project.validateDirectory"; localPath: string }
  ...
  | { type: "skills.listSaved"; projectId?: string | null }
  | {
  ...
  | { type: "chat.create"; projectId: string; taskId?: string | null; title?: string | null }
